...
def local_rules_block(entry_label: str) -> list[str]:
    return [
        ...
        "- Unless absolutely necessary, do not run work blindly. Add enough logging, checkpoints, and external progress checks to understand what the run is doing.",
        ...
        "- [ ] Confirmed instrumentation is sufficient to observe logs, checkpoints, and progress/resource signals",
...
def memory_block(*, entry_kind: str, status: str, objective: str, source_ids: list[str]) -> list[str]:
    return [
        ...
        "",
        "- Primary logs to watch:",
        "- Progress or checkpoint signals to probe periodically:",
        "- Resource or consumption signals to monitor periodically:",
        "",
        "## Update Triggers",
        "",
